...
- [ ] **Step 1:** Initialize a SvelteKit project in `ui/telemetry`.
- [ ] **Step 2:** Implement a WebSocket client store to connect to the FastAPI backend.
- [ ] **Step 3:** Build reactive UI components for Hardware Leases, Epoch loops, and the Tally Matrix.
- [ ] **Step 4:** Build the SvelteKit project into static assets suitable for embedding.

## Phase 3: The Next.js Feature Studio Shell
- [ ] **Step 1:** Initialize a Next.js project in `ui/studio`.
- [ ] **Step 2:** Build the layout shell (Sidebar, Header, Main Content Area).
- [ ] **Step 3:** Embed the compiled SvelteKit Telemetry Engine into the main dashboard view.
